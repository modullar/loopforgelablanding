(() => {
  ...
  const BEFORE = [{
    ...
    icon: "doc",
    label: "New Brief",
    short: "Design brief lands. Target: −8% unit cost."
  }, {
    time: "Day 1–4",
    type: "pain",
    tag: "Data Stitching",
    icon: "desert",
    label: "Data Desert",
    short: "ERP, CAD, Excel — days of gathering.",
    waste: 72,
    ...
    icon: "chart",
    label: "Estimate",
    short: "Finally has a cost picture."
  }, {
    time: "Day 5–9",
    type: "pain",
    tag: "Brain Drain",
    icon: "gap",
    label: "Expertise Gap",
    short: "Senior expert on leave.",
    waste: 58,
    wasteLabel: "blind spots"
  }, {
    time: "Day 10",
    type: "neutral",
    icon: "search",
    label: "Review",
    short: "Presents new assembly."
  }, {
    time: "Day 10–14",
    type: "pain",
    tag: "Redesign",
    icon: "return",
    label: "Square One",
    short: "Too expensive. Discovered too late.",
    waste: 85,
    wasteLabel: "rework prob."
  }, {
    time: "Day 15+",
    type: "neutral",
    icon: "loop",
    label: "Repeats",
    short: "Cost target unvalidated. Start over."
  }];
  const AFTER = [{
    time: "0 min",
    type: "neutral",
    icon: "doc",
    label: "Same Brief",
    short: "Same targets. Engine connected."
  }, {
    time: "2 min",
    type: "solved",
    tag: "Data Stitching",
    ...
    icon: "flash",
    label: "Instant Cost",
    short: "BOM auto-parsed and unified."
  }, {
    time: "5 min",
    type: "neutral",
    icon: "compass",
    label: "Exploring",
    short: "Engineer explores design variants."
  }, {
    time: "8 min",
    type: "solved",
    tag: "Tribal Know.",
    ...
    icon: "target",
    label: "Guided Moves",
    short: "Manufacturing constraints surfaced."
  }, {
    time: "12 min",
    type: "neutral",
    icon: "eye",
    label: "Review",
    short: "Presents validated design."
  }, {
    time: "15 min",
    type: "solved",
    tag: "Redesign",
    ref: "Square One",
    icon: "check",
    label: "1st-Time Right",
    short: "Everything validated before prototype."
  }, {
    time: "20 min",
    type: "neutral",
    icon: "done",
    label: "Done",
    short: "Design approved. Targets met."
  }];
  const STATS = [{
    value: "41–194%",
    label: "more hours over 20 years"
  }, {
    value: "80%",
    label: "of impact locked at design"
  }];
  function Ring({
    percent,
    active,
  ...
  function TimelineSection({
    ...
    useEffect(() => {
      ...
      const run = () => {
        ...
        step++;
        if (step < steps.length) timerRef.current = setTimeout(run, 1200);else setAutoplay(false);
      };
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      }, isActive && isHighlight && /*#__PURE__*/React.createElement(Pulse, {
        color: dotColor
      })), /*#__PURE__*/React.createElement("div", {
        style: {
          marginTop: 14,
    ...
    }, /*#__PURE__*/React.createElement("style", null, `@keyframes cardIn { from{opacity:0;transform:translateY(14px) scale(0.97)} to{opacity:1;transform:none}}`), d.type === "pain" && /*#__PURE__*/React.createElement(Ring, {
      percent: d.waste,
      active: revealed.has(active),
      delay: 0.15,
      variant: "gray"
    }), d.type === "solved" && /*#__PURE__*/React.createElement("div", {
      style: {
        width: 72,
        height: 72,
        borderRadius: "50%",
    ...
    }, d.type === "pain" && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: "0.62rem",
        fontWeight: 700,
        textTransform: "uppercase",
    ...
    }, d.wasteLabel), d.type === "solved" && d.ref && /*#__PURE__*/React.createElement("div", {
      style: {
        display: "inline-flex",
        alignItems: "center",
        gap: 6,
      ...
      color: C.orangeLight
    }), " ", d.ref, " \u2192 resolved"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontFamily: "'DM Serif Display',serif",
      ...
      style: {
        width: d.type === "neutral" ? 20 : 24,
        height: d.type === "neutral" ? 20 : 24,
        display: "inline-flex",
        color: d.type === "pain" ? C.warmGray : d.type === "solved" ? C.orange : isDark ? C.textDarkMuted : C.warmGrayLight,
        opacity: 0.8
      }
    }, /*#__PURE__*/React.createElement(MinimalIcon, {
      name: d.icon
    })), d.label), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: "0.9rem",
        color: isDark ? C.textDarkMuted : C.warmGray,
        lineHeight: 1.6,
        fontFamily: "'DM Sans',sans-serif"
      }
      ...
      style: {
        ...
        alignItems: "center",
        justifyContent: "center",
        color: isDark ? "#668877" : C.warmGrayLight,
        fontSize: "0.85rem",
        fontStyle: "italic",
        fontFamily: "'DM Sans',sans-serif"
      }
  ...
  function StatusQuoGap() {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, "Forge Engine"), " Clarity"), /*#__PURE__*/React.createElement("p", {
      style: {
    ...
    }, "Embed market, cost, and carbon data directly into the workflow. Stop the redesign trap before it starts.")), /*#__PURE__*/React.createElement(TimelineSection, {
    ...
    }, "Weeks \u2192 ", /*#__PURE__*/React.createElement("span", {
      style: {
        color: C.orange
      }
    ...
    }, "The economic brain for mechanical product innovation."))), /*#__PURE__*/React.createElement("div", {
      className: "sqg-slider-layer",
      style: {
    ...
    }, "\"Status Quo\""), " Gap"), /*#__PURE__*/React.createElement("p", {
      style: {
        color: C.warmGray,
        fontSize: "1.05rem",
        marginTop: 16,
    ...
    }, "80%"), " of environmental impact is decided at the design stage, yet engineers are designing in the dark.")), /*#__PURE__*/React.createElement(TimelineSection, {
      title: "Today:",
      ...
      style: {
        ...
        borderRadius: 14,
        borderTop: `3px solid ${C.warmGrayLight}`,
